...
SUBROUTINE set_data(x_min,x_max,y_min,y_max,     &
  ...
  IF(PRESENT(xarea)) THEN
    ...
    ALLOCATE(xarea(x_min-2:x_max+6 ,y_min-2:y_max+2))
    xarea = 0.0
  ENDIF
