...
void CloverCL::loadProgram(int xmin, int xmax, int ymin, int ymax)
{
    ...
    build_one_program(xmin, xmax, ymin, ymax, "accelerate_removeMemOp_double2_wg_singleWI_1921_3842_1922_1923_pipelineOpts_2Darray_rollingX_rollingY_finalIT.aocx", &accelerate_prog);
