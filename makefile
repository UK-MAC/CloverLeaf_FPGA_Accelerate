...
#OCL_ALTERA_INC=-I/opt/altera/14.1/hld/host/include
#OCL_ALTERA_LIB=-L/usr/lib64 -L/opt/altera/14.1/hld/linux64/lib -L/opt/altera/14.1/hld/host/linux64/lib -lalterahalmmd -lalterammdpcie -lalteracl -lelf -lrt -lstdc++
